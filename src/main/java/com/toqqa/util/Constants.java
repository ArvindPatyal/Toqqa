...
public class Constants {
	...
	public static final String CUSTOMER_NOTIFICAYION_TITLE = "Order";

	public static final String CUSTOMER_NOTIFICAYION_MESSAGE = "Your order with order number %s is %s ";
