...
//	List<Product> findByUserAndIsDeleted(User user, Boolean isDeleted);
    ...
    Page<Product> findByProductCategories_IdInAndIsDeleted(Pageable pageRequest, List<String> categoryId, Boolean isDeleted);


    Page<Product> findByProductCategories_IdInAndIsDeletedAndUser(Pageable pageRequest, List<String> categoryId, Boolean isDeleted, User user);
