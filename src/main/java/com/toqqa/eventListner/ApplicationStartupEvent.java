...
public class ApplicationStartupEvent implements CommandLineRunner {
    ...
    private void initSubcategories(){
        ...
        map.put("Manufacturer",Arrays.asList("Dining","Weavers","Jewellers","Fashion","Health and Beauty","Home and Lifestyle",
                "Sports","Outdoor","Gym and Fitness","Toys"));
    ...
    private void initRoles(){
        List<String> roles = Arrays.asList(RoleConstants.AGENT.getValue(),RoleConstants.CUSTOMER.getValue(),RoleConstants.SME.getValue());
        roles.forEach(role->{
